...
Use this local overlay after `using-superpowers-plus` routes planning to
`writing-plans` or `writing-roadmaps`.
...
- Active plans: `.agents/plans/YYYY-MM-DD-<feature-name>.md`
