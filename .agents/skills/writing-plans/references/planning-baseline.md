...
Read for repo-backed implementation planning before invoking the selected
planning lane.
...
Do not replace writing-plans, copy repository-specific paths into this
portable reference, or treat generated outputs as the edit point. The plan's
handoff must identify the local implementation guide and the execution lane.
