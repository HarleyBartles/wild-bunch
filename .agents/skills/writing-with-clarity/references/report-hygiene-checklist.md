...
Reports are not truth. Reports are compressed custody surfaces. The failure mode is report laundering: a smooth report turns a worker claim, Linear comment, PR body, validation note, package receipt, inference, or partial proof into durable truth.

A good report preserves category boundaries so later readers know what was observed, what was claimed, what was inferred, what was verified, and what remains unresolved.

## Keep lanes separate

When the report matters, keep these categories distinct:
...
## Ordinary coding-workflow report

For routine status, keep it boring:
