...
- `$writing-with-clarity` -> `references/report-hygiene-checklist.md`: report partitioning, report laundering hard stops, compact coding report shape, and false-GREEN risks.
