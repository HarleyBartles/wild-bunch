...
metadata:
  ...
  source_path: "sources/third_party/superpowers/obra-superpowers/v6.1.0/skills/subagent-driven-development/SKILL.md"
...
[Run review-package PLAN_FILE, dispatch task reviewer with the printed path]
