...
- Added upstream discovery fallback guidance so blocked reads, writes, and readbacks step back to a connector-observed parent discovery surface before retrying.
