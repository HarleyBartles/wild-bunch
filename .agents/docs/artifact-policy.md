...
### Index Mesh
The `INDEX.md` file in `.agents/superpowers/` is generated by `scripts/generate_index_mesh.py`. Do not hand-edit it for durable guidance — update `.agents/docs/artifact-policy.md` instead, then regenerate the index mesh.
