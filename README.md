...
- `AGENTS.md` — agent law, mesh policy, validation, and worker return format. Start here if you are an agent or a contributor working alongside one.
- [INDEX.md](INDEX.md) — generated navigation index for the whole repo.
- [docs/](docs/INDEX.md) — repo documentation and ADR log.

## Setup

- Backend: .NET 10. See `AGENTS.md` for the validation lane (`dotnet build`, `dotnet test`, `.\scripts\postgres-dev.ps1 validate`).
