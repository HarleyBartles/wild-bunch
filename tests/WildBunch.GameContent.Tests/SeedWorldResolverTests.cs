...
public sealed class SeedWorldResolverTests
{
    ...
    public void DifferentTownCountsProduceDifferentTrailCounts()
    {
        ...
        // SeedWorld.Trails is now obsolete - trails are generated by SeedWorldBuilder
    ...
    public void CanonicalSeedWorldHasEightTowns()
    {
        ...
        // SeedWorld no longer pre-generates trails - trails are generated by SeedWorldBuilder
        // after town coordinates settle (geometry-first approach)
        Assert.Empty(seedWorld.Trails);
    }
