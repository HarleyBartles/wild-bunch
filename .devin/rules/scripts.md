...
- **Use before reporting environmental issues or running ad-hoc commands:** [`scripts/README.md`](../../scripts/README.md) — script catalog, requirements, and conventions.
...
- **Use when you need the shared PostgreSQL service:** `tools/postgres-dev.ps1`
