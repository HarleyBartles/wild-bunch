...
- **Use when you have updated the agent-asset-marketplace submodule:** `scripts/install_agent_skills.sh` or `scripts/install_agent_skills.ps1`
- **Use when you need image asset processing:** `scripts/image_asset_pipeline.sh` or `scripts/image_asset_pipeline.ps1`
- **Use when you need to regenerate the index mesh:** `scripts/generate_index_mesh.sh` or `scripts/generate_index_mesh.ps1`
