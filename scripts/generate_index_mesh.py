...
EXCLUDED_DIR_NAMES = {".git", ".worktrees", "__pycache__", "bin", "obj", "node_modules", ".local", "sdd", "dist", "TestResults", "output", "marketplace-source", ".codex", ".playwright-mcp", ".superpowers", ".agents"}
EXCLUDED_ROOT_NAMES = {".git", ".worktrees", "__pycache__", "bin", "obj", "node_modules", ".local", "sdd", "dist", "TestResults", "output", "marketplace-source", ".codex", ".playwright-mcp", ".superpowers", ".agents"}
