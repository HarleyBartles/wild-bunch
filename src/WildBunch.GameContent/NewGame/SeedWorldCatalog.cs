...
internal static class SeedWorldCatalog
{
    ...
    /// <summary>
    /// Stub: trail generation is now done by MapGenerator at game setup time,
    /// not at seed resolution time. Returns an empty list.
    /// </summary>
    public static IReadOnlyList<SeedWorldTrail> BuildTrails(
        SeedWorldVariant variant,
        IReadOnlyList<TownNameEntry> townNames)
    {
        return Array.Empty<SeedWorldTrail>();
    }
