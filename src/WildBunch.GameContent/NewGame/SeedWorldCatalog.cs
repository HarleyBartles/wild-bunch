...
/// </summary>
public sealed record TownNameEntry(int Slot, string Id, string Name);
...
internal static class SeedWorldCatalog
{
    ...
    [
        new(0, "pinecross", "Pinecross"),
        new(1, "redmesa", "Red Mesa"),
        new(2, "holloway", "Holloway"),
        new(3, "sagewell", "Sagewell"),
        new(4, "dryfork", "Dry Fork"),
        new(5, "emberfall", "Emberfall"),
        new(6, "hardpan", "Hardpan"),
        new(7, "openpass", "Open Pass"),
        new(8, "dustwell", "Dustwell"),
        new(9, "silvercreek", "Silver Creek"),
        new(10, "rattleridge", "Rattle Ridge"),
        new(11, "cottonwood", "Cottonwood"),
        new(12, "boulderwash", "Boulder Wash"),
        new(13, "mesaverde", "Mesa Verde"),
        new(14, "coyotesprings", "Coyote Springs"),
        new(15, "ironflats", "Iron Flats"),
        new(16, "canyonfalls", "Canyon Falls"),
        new(17, "tumbleweed", "Tumbleweed"),
        new(18, "goldgulch", "Gold Gulch"),
        new(19, "brokenarrow", "Broken Arrow"),
        new(20, "whiskeyflats", "Whiskey Flats"),
        new(21, "ravenwood", "Ravenwood"),
        new(22, "saltflats", "Salt Flats"),
        new(23, "deadman", "Deadman's Crossing"),
        new(24, "buffalocreek", "Buffalo Creek"),
        new(25, "thunderbutte", "Thunder Butte"),
        new(26, "lassoranch", "Lasso Ranch"),
        new(27, "windygap", "Windy Gap"),
        new(28, "cinnabar", "Cinnabar"),
        new(29, "rustedspur", "Rusted Spur"),
        new(30, "hangmanstree", "Hangman's Tree"),
        new(31, "quartzsite", "Quartzsite"),
        new(32, "dovecreek", "Dove Creek"),
        new(33, "shadowridge", "Shadow Ridge"),
        new(34, "wildrose", "Wild Rose"),
        new(35, "barrelcactus", "Barrel Cactus"),
        new(36, "drygulch", "Dry Gulch"),
        new(37, "silverton", "Silverton"),
        new(38, "rattlesnake", "Rattlesnake"),
        new(39, "lostcanyon", "Lost Canyon")
    ];
