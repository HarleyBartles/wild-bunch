...
/// prosperity palette, cluster count, graph density, trail graph with baseline terrain/water/distance,
...
///   density (via GraphDensity), and the trail graph between slots.
