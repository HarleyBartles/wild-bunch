...
/// buildings and the player spawn position. Coordinates are in logical units
/// (0-100). Mirrors the domain
/// <see cref="WildBunch.Domain.World.TownLayout"/>. Consumed by the frontend
