...
/// PursuitHeat is future lawman pressure (ADR-0029), not trail danger. HeatIncrease carries
/// the trail event's heat delta (0 for private-hardship events; reserved for future noisy/witnessed events).
